<template>
  <div class="msds-container view-container">
    ...
    <el-form class="filter-form" style="margin:30px 0;">
     <el-input v-model="searchInputVal" placeholder="输入姓名.进行查询" clearable size="medium" style="width:280px;margin-right:20px;" />
    ...
    <el-table v-loading="loading" :data="tableData" :header-cell-style="{background:'#eef1f6',color:'#606266'}" border >
      <el-table-column prop="zhName" label="姓名" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="alias" label="通过数量" align="center" />
      <el-table-column :show-overflow-tooltip="true" prop="enName" label="不通过数量" align="center" />
      <el-table-column prop="casNo" label="检测总数量" align="center" />
    </el-table>

    <pagination :total="total" :page.sync="page" :limit.sync="limit" @pagination="getMsdsList" />

    <el-dialog :title="dialogTitle" :visible.sync="msdsInfoDialog" class="add-dialog" top="2vh" :close-on-click-modal="false" width="53%">
      <!--  -->
        ...
        <el-tab-pane label="基本信息" name="baseInfoTabPane">
          <el-form :model="baseInfoForm" label-width="120px" :inline="true">
            ...
            <el-form-item label="危化品类型:">
              <el-select v-model="baseInfoForm.chemicalsTypeId" clearable style="width:200px">
                <el-option v-for="item in chemicalsTypes" :key="item.id" :label="item.name" :value="item.id" />
              </el-select>
            </el-form-item>
            ...
            <el-form-item label="溶解性(mg/L):">
              <el-input v-model="baseInfoForm.solubility" type="textarea" style="width:200px" />
            </el-form-item>
            <el-form-item label="主要来源:">
              <el-input v-model="baseInfoForm.source" type="textarea" style="width:200px" />
            </el-form-item>
            <el-form-item label="危险性:">
              <el-input v-model="baseInfoForm.risk" type="textarea" style="width:530px" />
            </el-form-item>
            <el-form-item label="健康危害:">
              <el-input v-model="baseInfoForm.acuteHazard" type="textarea" style="width:530px" />
            </el-form-item>
            <el-form-item label="特别警示:">
              <el-input v-model="baseInfoForm.chronicHazard" type="textarea" style="width:530px" />
            </el-form-item>
            <el-form-item label="应急监测:">
              <el-input v-model="baseInfoForm.emergencyMonitoring" type="textarea" style="width:530px" />
            </el-form-item>
            <el-form-item label="环境标准:">
              <el-input v-model="baseInfoForm.environmentalStandards" type="textarea" style="width:530px;" />
            </el-form-item>
            <el-form-item label="理化物质:">
              <el-input v-model="baseInfoForm.physicochemicalProperty" type="textarea" style="width:530px" />
            </el-form-item>
            ...
            <el-row style="text-align:center;margin-top:10px">
              <el-button size="medium" @click="msdsInfoDialog=false">取消</el-button>
              <el-button type="primary" size="medium" style="margin-left:30px" @click="onSaveMsdsBaseInfo">保存</el-button>
            </el-row>
          </el-form>
        </el-tab-pane>
        <el-tab-pane label="应急处置" name="emergencyDisposalTabPane">
          <el-form :model="emergencyDisposalForm" label-width="105px">
            <el-form-item label="用水扑救后果:">
              <el-input v-model="emergencyDisposalForm.saveConsequences" type="textarea" />
            </el-form-item>
            <el-form-item label="灭火方法:">
              <el-input v-model="emergencyDisposalForm.extinguishingMethod" type="textarea" />
            </el-form-item>
            <el-form-item label="泄露应急处理:">
              <el-input v-model="emergencyDisposalForm.reveal" type="textarea" />
            </el-form-item>
            <el-form-item label="防护要求:">
              <el-input v-model="emergencyDisposalForm.protectionRequirements" type="textarea" />
            </el-form-item>
            <el-form-item label="防护距离:">
              <el-input v-model="emergencyDisposalForm.protectiveDistance" type="textarea" />
            </el-form-item>
            <el-row style="text-align:center;margin-top:30px">
              <el-button size="medium" @click="msdsInfoDialog=false">取消</el-button>
              <el-button type="primary" size="medium" style="margin-left:30px" @click="onSaveEmergencyDisposal">保存</el-button>
            </el-row>
          </el-form>
        </el-tab-pane>
        <el-tab-pane label="急救措施" name="firstAidMeasuresTabPane">
          <el-form :model="firstAidMeasuresForm" label-width="100px">
            <el-form-item label="皮肤接触:">
              <el-input v-model="firstAidMeasuresForm.skinExposure" type="textarea" />
            </el-form-item>
            <el-form-item label="眼睛接触:">
              <el-input v-model="firstAidMeasuresForm.eyeContact" type="textarea" />
            </el-form-item>
            <el-form-item label="吸入:">
              <el-input v-model="firstAidMeasuresForm.suction" type="textarea" />
            </el-form-item>
            <el-form-item label="食入:">
              <el-input v-model="firstAidMeasuresForm.ingestion" type="textarea" />
            </el-form-item>
            <el-row style="text-align:center;margin-top:30px">
              <el-button size="medium" @click="msdsInfoDialog=false">取消</el-button>
              <el-button type="primary" size="medium" @click="onSaveFirstAidMeasures">保存</el-button>
            </el-row>
          </el-form>
        </el-tab-pane>
      </el-tabs>
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      Object.keys(obj).forEach((key) => {
        ...
        } else if (Object.prototype.hasOwnProperty.call(this.emergencyDisposalForm, key)) {
          this.emergencyDisposalForm[key] = obj[key]
        } else if (Object.prototype.hasOwnProperty.call(this.firstAidMeasuresForm, key)) {
    ...
    onSaveMsdsBaseInfo() {
      ...
      if (this.msdsInfoDialogType === 'add') {
        addMsdsBaseInfo(this.baseInfoForm).then(res => {
          /* console.log(res) */
          this.getMsdsList()
    ...
    onSaveEmergencyDisposal() {
      if (this.msdsInfoDialogType === 'add') {
        addMsdsEmergencyDisposal(this.emergencyDisposalForm).then(res => {
          /* console.log(res) */
          this.getMsdsList()
        ...
        updateMsdsEmergencyDisposal(this.emergencyDisposalForm).then(res => {
          this.getMsdsList()
          this.activeTabPaneName = 'firstAidMeasuresTabPane'
        }).catch(err => {
          console.log(err)
    ...
    onSaveFirstAidMeasures() {
      if (this.msdsInfoDialogType === 'add') {
        addFirstAidMeasures(this.firstAidMeasuresForm).then(res => {
          /* console.log(res) */
          this.getMsdsList()
        ...
        updateFirstAidMeasures(this.firstAidMeasuresForm).then(res => {
          this.getMsdsList()
          this.activeTabPaneName = 'baseInfoTabPane'
        }).catch(err => {
          console.log(err)
