      ...
      <el-container>
        <el-aside width="450px" class="aside">
          <el-form>
            <el-image
              class="avatar"
              :src="dialogTableData && dialogTableData.sourceUrl"
              :preview-src-list="[dialogTableData && dialogTableData.sourceUrl]"
            >
            </el-image>
          </el-form>
        </el-aside>
            ...
            <el-col :span="7"
              ><div class="grid-content bg-purple">
                ...
                <div class="dd">
                  ...
                  >
                    <option
                      v-for="(item, i) in dialogSelectBrandItems"
                      :value="i"
                    >
                      {{ item.bName }}
                    </option>
            ...
            <el-col :span="6"
              ><div class="grid-content bg-purple">
                ...
                <div class="dd">
                  ...
                  >
                    <option
                      v-for="(item, i) in dialogProductFieldItems"
                      :value="i"
                    >
                      {{ item.keyword }}
                    </option>
...
export default {
  ...
  methods: {
    ...
    viewDetils (row) {
      ...
      // this.$refs.brandSearchInput.input.focus()
      this.dialogSearchEngineer()
    },
    getnull () {
