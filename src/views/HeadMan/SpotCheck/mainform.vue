  ...
  <div class="msds-container view-container">
    <div class="main-left">
      ...
      <div class="main-left-top">
        ...
        <img src="../../../assets/zhongqiu.jpg" class="showimg" />
      </div>
      <div class="main-bottm">
        <el-button type="" size="mini" icon="el-icon-zoom-in" @click="bigit" round
          >放大</el-button
        >
        <el-button type="" size="mini" icon="el-icon-zoom-out" @click="littleit" round
          >缩小</el-button
        >
      </div>
    </div>
    <div class="main-right">
      <div class="main-content">
        <el-form label-width="80px">
          ...
          <el-form-item>
            <div class="main-bottm">
              <el-button type="success" size="mini" round>通过</el-button>
              <el-button type="danger" size="mini" round>不通过</el-button>
            </div>
          </el-form-item>
        </el-form>
      </div>
